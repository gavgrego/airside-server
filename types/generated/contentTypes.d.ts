...
export interface ApiAirportAirport extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    lounges: Schema.Attribute.Relation<'oneToMany', 'api::lounge.lounge'>;
    name: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiAllianceTierAllianceTier
  extends Struct.CollectionTypeSchema {
...
export interface ApiCardCard extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    name: Schema.Attribute.String;
    processor: Schema.Attribute.Enumeration<['Visa', 'Amex', 'Mastercard']>;
    bank: Schema.Attribute.Enumeration<
      [
        'Chase',
        'Amex',
        'Barclays',
    ...
    >;
    annualFee: Schema.Attribute.Decimal;
    icon: Schema.Attribute.Media<'images'>;
    personalOrBiz: Schema.Attribute.Enumeration<['Personal', 'Business']>;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiDetrimentDetriment extends Struct.CollectionTypeSchema {
...
export interface ApiLoungeLounge extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    airport: Schema.Attribute.Relation<'manyToOne', 'api::airport.airport'>;
    ...
    priorityPass: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    detriments: Schema.Attribute.Relation<
      'oneToMany',
      'api::detriment.detriment'
    >;
    daypass: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
      }>;
    alliance_access: Schema.Attribute.Relation<
      'oneToMany',
      'api::alliance-tier.alliance-tier'
    >;
    ambiguous_access: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
      ...
      Schema.Attribute.DefaultTo<false>;
    guest: Schema.Attribute.RichText &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::lounge.lounge'>;
  };
}
